...
public class JoyStick2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (MoveFlag)
        {
            speed = Player.GetComponent<PlayerCtrl>().speed;
    ...
    public void Drag(BaseEventData _Data)
    {
        ...
        // 거리가 반지름보다 커지면 조이스틱을 반지름의 크기만큼만 이동.
            ...
            Stick.position = StickFirstPos + JoyVec * Radius*0.6f;

        Player.eulerAngles = new Vector3(JoyVec.y * -5, JoyVec.x*5);    // 실제로 이동을 담당하는 부분
    }
